...
# grado y área:
#
#   promedio_simce ~ mean_logro + last_logro + slope_logro + n_evals_prom
#
...
formula_modelo <- promedio_simce ~ mean_logro + last_logro + slope_logro + n_evals_prom
...
ggsave("output/diagnostico_observado_vs_predicho.png", p, width = 8, height = 6)

# ---- Guardar modelos y métricas ----------------------------------------
saveRDS(modelos, file.path(dir_salidas, "modelos_escolares.rds"))
write_csv(tabla_resultados, file.path(dir_salidas, "metricas_validacion.csv"))
